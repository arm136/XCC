...
const pythonDefault = `# Python 3 code to find sum
...
const Landing = () => {
  ...
  // Using the checkStatus method for polling the '/submissions/${token}' route.
  ...
  // Handling the compilation on clicking the COMPILE or EXECUTE button.
